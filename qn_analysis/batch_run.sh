...
/scratch1/mmamaev/QnAnalysis/build/src/QnAnalysisCorrect/QnAnalysisCorrect \
                                                                          ...
                                                                          --yaml-config-file /scratch1/mmamaev/QnAnalysis/setups/bmatn/xecs_mc_corrections.yml \
...
/scratch1/mmamaev/QnAnalysis/build/src/QnAnalysisCorrelate/QnAnalysisCorrelate \
                                                                              ...
                                                                              --configuration-file /scratch1/mmamaev/QnAnalysis/setups/bmatn/xecs_mc_correlations.yml \
