...
do
  ...
  root -q "/lustre/stor1/parfenov/bmnroot/macro/run/run_sim_bmn.C( $str_input_file, $str_sim_file_name, $start, $n_events, UNIGEN, true, 3.85/4.82 )"

  root -q "/lustre/stor1/parfenov/bmnroot/macro/run/run_reco_bmn.C( $str_sim_file_name, $str_rec_file_name, 0, $n_events )"

  root -q "/lustre/stor1/parfenov/bmnroot/analysis/common/macro/run_analysis_tree_maker.C( $str_rec_file_name, $str_sim_file_name, $str_geometry_file, $str_atree_file_name, 3.0 )"
